	...
	return (
		<div className="bg-slate-800 text-white shadow-lg fixed top-0 left-0 w-full">
			<div className="flex md:px:10 px-7 py-4 justify-between items-center">
				...
				<div className="md:w-1/3 w-3/6 mx-1">
					{/* <button
						type="button"
					...
					<div className="relative md:block w-">
						...
						<input
							type="text"
							id="search-navbar"
							className="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600  dark:hover:bg-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
							placeholder="Search..."
						/>
					</div>
					{/* <button
						data-collapse-toggle="navbar-search"
						type="button"
						className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:focus:bg-gray-600 dark:hover:bg-gray-900 dark:focus:ring-gray-600"
						aria-controls="navbar-search"
						aria-expanded="false">
